...
def deploy_to_render():
    ...
    cmd = [
        ...
        "--env-var", f"PLIVO_AUTH_ID={os.getenv('PLIVO_AUTH_ID', '')}",
        "--env-var", f"PLIVO_AUTH_TOKEN={os.getenv('PLIVO_AUTH_TOKEN', '')}",
        "--env-var", f"PLIVO_PHONE_NUMBER={os.getenv('PLIVO_PHONE_NUMBER', '')}",
